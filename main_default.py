from lib import get_lowest_tetradic_number_index, make_tetradic_number_with_lru_memorization
import sys
import time
import numpy as np
...
def find_sums(input_number):
  ...
  def iterate_sum(iterable_number_index, sum):
    ...
    for number_index in range(nearest_tetradic_number_index, 0, -1):
      number = make_tetradic_number_with_lru_memorization(number_index)
